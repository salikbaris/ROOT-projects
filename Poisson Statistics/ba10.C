void ba10() {
    ...
    const char *title = "Ba, 10 second interval;Number of #gamma-rays Emitted;Number of Occurance";

    // Name of the data file.
    const char *file_name = "BA10.txt";

    // Name of the file that's created at the end.
    const char *print_name = "ba10.pdf";
    ...
    Double_t pt_xmin = 26.639;
    Double_t pt_ymin = 14.9171;
    Double_t pt_xmax = 37.9212;
    Double_t pt_ymax = 40.94;

    // Positioning of the legend, NDC.
    Double_t lg_xmin = 0.13467;
    Double_t lg_ymin = 0.668776;
    Double_t lg_xmax = 0.411175;
