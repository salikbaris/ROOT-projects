void cs01() {
    ...
    const char *title = "Cs, 1 second interval;Number of #gamma-rays Emitted;Number of Occurance";

    // Name of the data file.
    const char *file_name = "CS01.txt";

    // Name of the file that's created at the end.
    const char *print_name = "cs01.pdf";
    
    // Histogram x-axis range.
    // Mainly used automatic range setting but in some cases of overflow or bad fit,
    // ranges were set manually.
    Double_t h_xmin = 2;
    Double_t h_xmax = 18.1;

    // Positioning of the stat box, user range.
    Double_t pt_xmin = 14.2884;
    Double_t pt_ymin = 9.19831;
    Double_t pt_xmax = 19.5647;
    Double_t pt_ymax = 23.4968;

    // Positioning of the legend, NDC.
    Double_t lg_xmin = 0.12894;
    Double_t lg_ymin = 0.765823;
    Double_t lg_xmax = 0.372493;
    Double_t lg_ymax = 0.881857;
