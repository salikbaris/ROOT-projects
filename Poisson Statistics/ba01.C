void ba01() {
    ...
    const char *title = "Ba, 1 second interval;Number of #gamma-rays Emitted;Number of Occurance";

    // Name of the data file.
    const char *file_name = "BA01.txt";

    // Name of the file that's created at the end.
    const char *print_name = "ba01.pdf";
    ...
    // Double_t pt_xmin = 4.335;
    // Double_t pt_ymin = 41.9698;
    // Double_t pt_xmax = 5.61;
    // Double_t pt_ymax = 51.2308;

    Double_t pt_xmin = 4.39685;
    Double_t pt_ymin = 15.5687;
    Double_t pt_xmax = 6.5351;
    Double_t pt_ymax = 33.1587;

    // Positioning of the legend, NDC.
    Double_t lg_xmin = 0.445559;
    Double_t lg_ymin = 0.757384;
    Double_t lg_xmax = 0.680516;
    Double_t lg_ymax = 0.900844;
    ...
    TH1D *h1 = new TH1D("h1", title, 6, h_xmin, h_xmax);
