...
void analysis_turquoise() {
    ...
    Double_t f1_xmin = 0;
    Double_t f1_xmax = 283.1;
    Double_t f2_xmin = 1573;
    Double_t f2_xmax = 3055;
    ...
    Double_t arr_ofsy = 0.03;

    // These values define the position of the box.
    Double_t p_xmin = 2000;
    Double_t p_xmax = 3500;
    Double_t p_ymin = 0.6;
    Double_t p_ymax = 0.9;

    // Creating graph and getting the point and error values from the file.
    TGraphErrors *gr = new TGraphErrors("data_turquoise.txt");
