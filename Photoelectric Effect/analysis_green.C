...
// the intersection point of the two linear functions.
TF1 *f1l, *f2l;
...
void analysis_green() {
    ...
    Double_t f1_xmin = 102.8;
    Double_t f1_xmax = 224.4;
    Double_t f2_xmin = 1047;
    Double_t f2_xmax = 2719;
    ...
    // Creating graph and getting the data and error values from the file.
    TGraphErrors *gr = new TGraphErrors("data_green.txt");
